...
export const brands: Brand[] = [
  ...
  // NEW BRANDS - Placeholder data
  {
    id: '6',
    slug: 'capisvirleo',
    name: 'Capisvirleo',
    location: 'TBD, India',
    description: 'Brand description coming soon.',
    story: 'Brand story coming soon. Full details will be provided later.',
    category: 'Contemporary',
    season: 'Summer/Spring',
    tags: ['Coming Soon'],
    heroImage: '/images/home/Q_BB_Capisvirleo.png',
    collageImages: [],
    collections: [],
  },
  {
    ...
    season: 'Summer/Spring',
    tags: ['Coming Soon'],
    heroImage: '/brand-media/Day & Age/Q_BB_Day&Age.png',
    collageImages: [],
    collections: [],
  },
  {
    ...
    season: 'Summer/Spring',
    tags: ['Coming Soon'],
    heroImage: '/brand-media/Guapa/First_banner_Guapa.png',
    collageImages: [],
    collections: [],
  },
  {
    ...
    season: 'Summer/Spring',
    tags: ['Coming Soon'],
    heroImage: '/brand-media/ka sha/First_banner_Kasha.png',
    collageImages: [],
    collections: [],
  },
  {
    ...
    season: 'Summer/Spring',
    tags: ['Coming Soon'],
    heroImage: '/images/home/Q_BB_Khara_Kapas.png',
    collageImages: [],
    collections: [],
  },
];
