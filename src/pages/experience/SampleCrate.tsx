    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-background border-b border-border">
        <div className="flex items-center justify-between px-8 py-6">
          ...
          <span className="text-luxury-sm tracking-widest">SAMPLE CRATE</span>
          <div className="w-20" />
        </div>
      </div>
            ...
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  {/* Product Image */}
                  <div 
                    className={`aspect-[3/4] mb-4 overflow-hidden cursor-pointer border-2 transition-colors ${
                  ...
                  >
                    ...
                    {/* Selection Indicator */}
                    <div className={`absolute top-4 right-4 w-8 h-8 border-2 flex items-center justify-center transition-all ${
                      isSelected 
                        ? 'bg-gold border-gold' 
