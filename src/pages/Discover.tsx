        ...
        {(category || season) && (
          ...
          >
            <p className="text-luxury-label text-center text-base">
              Showing brands for {season && <span className="text-gold">{season}</span>}
              {category && season && " · "}
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h1 className="font-serif text-6xl lg:text-7xl font-light mb-6">{activeBrand?.name}</h1>

                <p className="text-muted-foreground leading-relaxed mb-8 max-w-md text-lg">{activeBrand?.story}</p>
          ...
          {filteredBrands.map((brand, index) => (
            ...
            >
              ...
              {index === activeBrandIndex && (
                <motion.div layoutId="activeLabel" className="absolute bottom-0 left-0 right-0 h-0.5 bg-gold" />
              )}
            </button>
          ))}
        </div>
