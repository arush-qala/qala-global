      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-background border border-border shadow-5xl max-w-md w-full mx-6 p-8"
...
const StatementOverlay = ({ currentSlideIndex }: StatementOverlayProps) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-center gap-4 pointer-events-auto bg-background/80 backdrop-blur-sm py-6 px-12 w-full max-w-2xl">
